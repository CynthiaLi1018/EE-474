...
// This file has been provided as the starter code.
// task1b_Inits.c contains all the initialization functions for Lab3 task 1b.
// The majority of this file is the same as task1a_Inits.c except we replaced
// LED_Init with SW_Init.
...
void ADCReadPot_Init(void)
{
  ...
  while (PLLSTAT != 0x1); // 2.4: Wait for the PLL to lock
