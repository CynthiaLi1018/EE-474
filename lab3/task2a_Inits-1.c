...
// task2a_Inits is basically the same as the task1b_inits. It contains all the
// initialization functions for task 2a. I added UART0's initialization as
// instructed by the specification.
