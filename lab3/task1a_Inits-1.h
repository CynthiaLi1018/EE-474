...
// This is the header file for the task1a's intialization functions.
// It is the starter code.

#ifndef _TASK1A_Inits_H_
#define _TASK1A_Inits_H_
