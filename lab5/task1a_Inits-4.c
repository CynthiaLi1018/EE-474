...
// task1a_Inits.c contains all the initialization functions for Lab3 task 1a.
// Initializationa are completed following the comment and datasheet.
