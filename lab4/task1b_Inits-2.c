...
// This file was provided as the starter code for lab 3, and is copied from
// lab 3 to achieve the same functionality to initialize PLL, ADC, Switches.
// task1b_Inits.c contains all the initialization functions for Lab4 task 1b.
